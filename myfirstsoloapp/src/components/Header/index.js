...
const Header = () => {
    return (
        <div className="headerWrapper">
            ...
            <p>if this page looks empty when you're here then give the browser a refresh a few times. I am using an external service to provide me images and I have zero control over whether it works or not. You should see something like this(insert hyperlink here Christopher!!!)</p>
            <ul>
